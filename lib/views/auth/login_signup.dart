            ...
            child: Column(
              children: [
                ...
                isSignUp
                  ...
                  child: myText(
                    text:
                    'Bem-vindo de volta, faça login e continue sua jornada conosco.',
                    style: GoogleFonts.roboto(
                      letterSpacing: 0,
                      fontSize: 18,
                      fontWeight: FontWeight.w400,
            ...
            children: [
              myTextField(
                  ...
                  validator: (String input){
                    ...
                    if(!input.contains('@')){
                      Get.snackbar('Aviso', 'E-mail obrigatório',colorText: Colors.white,backgroundColor: Colors.blue);
                      return '';
                    }
                  },
              ...
              myTextField(
                  ...
                  validator: (String input){
                    if(input.isEmpty){
                      Get.snackbar('Aviso', 'Senha obrigatório',colorText: Colors.white,backgroundColor: Colors.blue);
                      return '';
                    }
          ...
          children: [
            ...
            myTextField(
                ...
                validator: (String input){
                  ...
                  if(!input.contains('@')){
                    Get.snackbar('Aviso', 'E-mail inválido.',colorText: Colors.white,backgroundColor: Colors.blue);
                    return '';
                  }
                },
                controller: emailController
            ...
            myTextField(
                ...
                validator: (String input){
                  if(input.isEmpty){
                    Get.snackbar('Aviso', 'Senha necessária',colorText: Colors.white,backgroundColor: Colors.blue);
                    return '';
                  }
            ...
            myTextField(
                ...
                validator: (input){
                  if(input != passwordController.text.trim()){
                    Get.snackbar('Aviso', 'Confirmar senha não é o mesmo que senha.',colorText: Colors.white,backgroundColor: Colors.blue);
                    return '';
                  }
                },
