...
import 'package:trybu_comform/controller/data_controller.dart';
import 'package:trybu_comform/model/event_media_model.dart';
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Form(
            ...
            child: Column(
              children: [
                iconWithTitle(text: 'Criar Evento', func: () {}),
                SizedBox(
                ...
                myTextField(
                    ...
                    validator: (String input) {
                      if (input.isEmpty) {
                        Get.snackbar("O nome do evento é obrigatório.",
                      ...
                      if (input.length < 3) {
                        Get.snackbar(
                            "O nome do evento deve ter mais de 3 caracteres.,
                            colorText: Colors.white,
                            backgroundColor: Colors.blue);
                        return '';
                      }
                ...
                myTextField(
                    ...
                    validator: (String input) {
                      if (input.isEmpty) {
                        Get.snackbar('Localização é obrigatória",
                            colorText: Colors.white,
                            backgroundColor: Colors.blue);
                        return '';
                      }
                      ...
                      if (input.length < 3) {
                        Get.snackbar('Localização invalida",
                            colorText: Colors.white,
                            backgroundColor: Colors.blue);
                        return '';
                      }
                ...
                Row(
                  ...
                  children: [
                    iconTitleContainer(
                      ...
                      validator: (input) {
                        if (date == null) {
                          Get.snackbar('Data é obrigatória",
                              colorText: Colors.white,
                              backgroundColor: Colors.blue);
                          return '';
                        }
                    ...
                    iconTitleContainer(
                        path: 'assets/#.png',
                        text: 'Entradas máximas',
                        controller: maxEntries,
                        type: TextInputType.number,
                        onPress: () {},
                        validator: (String input) {
                          if (input.isEmpty) {
                            Get.snackbar('Entradas obrigatórias",
                                colorText: Colors.white,
                                backgroundColor: Colors.blue);
                            return '';
                          }
                ...
                iconTitleContainer(
                    path: 'assets/#.png',
                    text: 'Insira as tags que irão com o evento.',
                    ...
                    validator: (String input) {
                      if (input.isEmpty) {
                        Get.snackbar("Tags obrigatórias",
                            colorText: Colors.white,
                            backgroundColor: Colors.blue);
                        return '';
                      }
                ...
                Container(
                  ...
                  child: TextFormField(
                    ...
                    validator: (String? input) {
                      if (input!.isEmpty) {
                        Get.snackbar("A frequência é necessária."
                            colorText: Colors.white,
                            backgroundColor: Colors.blue);
                        return '';
                      }
                ...
                Container(
                  ...
                  child: TextFormField(
                    ...
                    validator: (input) {
                      if (input!.isEmpty) {
                        Get.snackbar("Descrição obrigatória.",
                            colorText: Colors.white,
                            backgroundColor: Colors.blue);
                        return '';
                      }
                    ...
                    decoration: InputDecoration(border: InputBorder.none,
                      ...
                      hintText:
                      'Escreva um resumo e quaisquer detalhes que seu convidado deva saber sobre o evento...',
                      // border: OutlineInputBorder(
                      //   borderRadius: BorderRadius.circular(8.0),
                      // ),
                    ),
                ...
                Row(
                  ...
                  children: [
                    ...
                    iconTitleContainer(
                        ...
                        validator: (String input) {
                          if (input.isEmpty) {
                            Get.snackbar(, "Preço é obrigatório.",
                                colorText: Colors.white,
                                backgroundColor: Colors.blue);
                            return '';
                          }
                ...
                Obx(() => isCreatingEvent.value
                  ...
                  child: elevatedButton(
                      ...
                      onpress: () async {
                        ...
                        if (media.isEmpty) {
                          Get.snackbar("Mídia é necessária.",
                              colorText: Colors.white,
                              backgroundColor: Colors.blue);
  ...
  void mediaDialog(BuildContext context) {
    showDialog(
        builder: (BuildContext context) {
          return AlertDialog(
            title: Text("Selecione o tipo de mídia"),
            content: Row(
              mainAxisAlignment: MainAxisAlignment.spaceAround,
              children: [
                IconButton(
