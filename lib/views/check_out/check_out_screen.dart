...
import 'package:trybu_comform/services/payment_service/payment_service.dart';
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  Row(
                    children: [
                      ...
                      myText(
                        text: 'Adicionar detalhes do cartão',
                        style: TextStyle(
                          fontSize: 13,
                          fontWeight: FontWeight.w600,
                        ),
              ...
              textField(text: 'Número do cartão'),
              Row(
                children: [
                  Expanded(
                    child: Container(
                  ...
                  Expanded(child: textField(text: 'Código de segurança'))
                ],
              ),
              SizedBox(
