                ...
                textField(
                    ...
                    validator: (String input) {
                      if (firstNameController.text.isEmpty) {
                        Get.snackbar('Primeiro Nome é obrigatório.',
                ...
                textField(
                    ...
                    validator: (String input) {
                      if (lastNameController.text.isEmpty) {
                        Get.snackbar('Sobrenome é obrigatório.',
                            colorText: Colors.white,
                            backgroundColor: Colors.blue);
                        return '';
                      }
                ...
                textField(
                    ...
                    validator: (String input) {
                      if (mobileNumberController.text.isEmpty) {
                        Get.snackbar( 'Contacto é obrigatório.',
                            colorText: Colors.white,
                            backgroundColor: Colors.blue);
                        return '';
                      }
                      ...
                      if (mobileNumberController.text.length < 10) {
                        Get.snackbar('Insira um numero de telefone grátis',
                            colorText: Colors.white,
                            backgroundColor: Colors.blue);
                        return '';
                      }
                ...
                Obx(()=> authController!.isProfileInformationLoading.value? Center(child: CircularProgressIndicator(),) :Container(
                  ...
                  child: elevatedButton(
                    ...
                    onpress: () async{
                      ...
                      authController!.uploadProfileData(imageUrl, firstNameController.text.trim(), lastNameController.text.trim(), mobileNumberController.text.trim(), dob.text.trim(), selectedRadio ==0 ? "Masculino": "Femenino");
                ...
                Container(
                    ...
                    child: RichText(
                      ...
                      text: TextSpan(children: [
                        ...
                        TextSpan(
                            text: 'termos, política de dados e política de cookies',
                            style: TextStyle(
