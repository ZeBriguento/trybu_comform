...
dataController!.createNotification(widget.uid!);
                              ...
                              LocalNotificationService.sendNotification(title: 'Nova Mensagem',message: message,token: widget.fcmToken);
                  ...
                  child: SizedBox(
                    ...
                    child: EmojiPicker(
                        ...
                        config: Config(
                            ...
                            showRecentsTab: true,
                            recentsLimit: 28,
                            noRecentsText: 'Sem mensagens recentes',
